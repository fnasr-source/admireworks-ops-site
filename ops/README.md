...
The **canonical reusable system** for multi-client direct-response onboarding, launch, optimization, admin workflows, and live QA.

**Key files:**
- `README.md` — Step-by-step operating model from discovery through maintenance
- `reference-systems/the-slim-game.md` — Reusable funnel, creative, and admin lessons
- `reference-systems/edrak-space.md` — Webinar, WhatsApp, AI reply, and admin operations lessons
- `checklists/post-deployment-live-qa.md` — Standard post-build and post-deploy verification flow
- `workflows/` — Reusable SOPs for offers, retention, and admin operations
